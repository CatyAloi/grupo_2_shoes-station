...
app.get('/detalleproducto', (req, res) => {res.sendFile(path.resolve(__dirname,'./views/detalle_producto.html')); });
...
app.get('/login', (req, res) => {res.sendFile(path.resolve(__dirname,'./views/form_login.html')); });
